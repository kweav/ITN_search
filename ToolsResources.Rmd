...
toolsresources_table <- setup_table(prep_table(as_tibble(courses_toolresource), current = TRUE), "Tools & Resources Courses Currently Available")
```
